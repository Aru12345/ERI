...
function Livinglab(){
    ...
    const handleChange =
      ...
      return(
        ...
        <Box sx={{margin:"110px",marginTop:"150px",marginLeft:"20px", height:"80vh",width:{xs:"80%",md:"85%",xl:"95%"}}}>
            ...
            textShadow: "1px 1px 3px #40bf69", fontWeight:"bold"}}>Living Lab</Typography>
            <Box>
            <div>
    ...
    background: 'linear-gradient(to left, #2bd469, #0ef1c2, #2bd469)',
        ...
        <AccordionSummary aria-controls="panel1d-content" id="panel1d-header">
          <Typography component="span" sx={{fontWeight:"bold"}}>Ecovillage development programs Nigeria</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
      ...
      <Accordion expanded={expanded === 'panel2'} onChange={handleChange('panel2')} sx={{background: 'linear-gradient(to left, #2abfd5, #00c4ff,#2abfd5)'}}>
        <AccordionSummary aria-controls="panel2d-content" id="panel2d-header">
          <Typography  fontWeight="bold" component="span">REDES</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
      ...
      <Accordion expanded={expanded === 'panel3'} onChange={handleChange('panel3')} sx={{  background: 'linear-gradient(to left, #2bd469, #0ef1c2, #2bd469)'}}>
        <AccordionSummary aria-controls="panel3d-content" id="panel3d-header">
          <Typography component="span" sx={{fontWeight:"bold"}}>Mobile Living Lab Programe</Typography>
        </AccordionSummary>
        <AccordionDetails>
          <Typography>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse
